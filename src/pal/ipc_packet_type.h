...
enum IPC_PACKET_TYPE
{
	...
	PT_PRIV_WIN32_NTFS_TRACING_INITIALIZE = 0x15320100, /* (UUID) (FD, Journal ID*/
	PT_PRIV_WIN32_NTFS_TRACING_CONTINUE = 0x15320101, /* (UUID, Start_USN, Journal ID), Returns (FD, FD_StartUSN, Journal ID) */
